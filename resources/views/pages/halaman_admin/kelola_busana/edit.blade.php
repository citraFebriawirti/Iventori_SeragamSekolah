...
@section('content')
    ...
    <main class="h-full pb-16 overflow-y-auto">
        ...
        <section class="max-w-[990px] p-6 mx-auto bg-slate-100 rounded-md shadow-md dark:bg-gray-800 mt-10">
            <h1 class="text-xl font-bold text-slate-900 capitalize dark:text-slate-900">Edit Data Busana</h1>
            @if (session('success'))
            ...
            @endif
            <form action="{{ route('busana.update', $dataById->id_busana) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="w-72">
                        <div class="relative h-10 w-full min-w-[450px] mt-5">
                            <input
                                ...
                                placeholder=" " name="nama_busana" value="{{ $dataById->nama_busana }}" />
                            <label
