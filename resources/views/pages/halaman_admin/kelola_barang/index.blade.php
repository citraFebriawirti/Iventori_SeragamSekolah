...
<main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
      ...
      <div class="flex justify-between">
        ...
        <!-- Sisi kanan -->
        <div class="px-6 my-6">
          <a href="{{route('barang.create')}}" class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
            Tambah 
  ...
  <thead>
      <tr>
        <th class="border border-slate-200 text-center">No</th>
          ...
          <th class="border border-slate-200  text-center">Jumlah Stok</th>
  ...
  <tbody>
   ...
   <tr>
    <td class="border border-slate-200 text-center">{{$loop->iteration}}</td>
      <td class="border border-slate-200 text-center">{{$baris->nama_barang}}</td>
      <td class="border border-slate-200 whitespace-pre-line text-center">{{$baris->jumlah_stok}}</td>
    ...
    <td class="border border-slate-200">
      ...
      <td class="border border-slate-200"> <div class="flex items-center space-x-4 text-sm">
        <a href="{{route('barang.edit',$baris->id_barang)}}">
          <button
      ...
      >
        ...
        <svg
          ...
          height="24"
          viewBox="0 0 24 24"
          style="fill: yellow; transform: ; msFilter:;"
        >
          <path
