...
@section('content')
    ...
    <main class="h-full pb-16 overflow-y-auto">
        ...
        <section class="max-w-[990px] p-6 mx-auto bg-slate-100 rounded-md shadow-md dark:bg-gray-800 mt-10">
            <h1 class="text-xl font-bold text-slate-900 capitalize dark:text-slate-900">Tambah Data gender</h1>
            @if (session('success'))
            ...
            @endif
            <form action="{{ route('gender.store') }}" method="post" enctype="multipart/form-data">
