            ...
            <table id="example" class="display border border-slate-200" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="border border-slate-200 text-center">Nama gender</th>
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-200">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('gender.edit', $baris->id_gender) }}">
                                        <button
                                    ...
                                    <form action="{{ route('gender.destroy', $baris->id_gender) }}" method="post"
