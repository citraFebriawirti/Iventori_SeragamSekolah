                ...
                <tbody>
                    ...
                    @foreach ($admin as $baris)
                        <tr>
                            ...
                            <td class="border border-slate-200 text-center">{{ $baris->nama_admin }}</td>
                                ...
                                <div class="flex items-center justify-center text-sm">
                                    ...
                                    <div class="relative hidden w-32 h-32 rounded-full md:block">
                                        <img class="object-cover w-full h-full rounded-lg"
                                            src="{{ asset($baris->gambar_admin) }}" alt="" loading="lazy" />
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="border border-slate-200">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('admin.edit', $baris->id_admin) }}">
                                        <button
                                    ...
                                    <form action="{{ route('admin.destroy', $baris->id_admin) }}" method="post"
