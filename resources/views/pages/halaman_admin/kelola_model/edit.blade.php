...
@section('content')
    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
            ...
            <div class="flex justify-between">
                ...
                <ol class="flex items-center whitespace-nowrap min-w-0 " aria-label="Breadcrumb">
                    ...
                    <li class="text-sm">
                        <a class="flex items-center text-gray-500 hover:text-blue-600" href="{{ route('model.index') }}">
                            Kelola Data Model
                            <svg class="flex-shrink-0 mx-3 overflow-visible h-2.5 w-2.5 text-gray-400 dark:text-gray-600"
                                width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="max-w-[990px] p-6 mx-auto bg-slate-100 rounded-md shadow-md dark:bg-gray-800 mt-10">
            <h1 class="text-xl font-bold text-slate-900 capitalize dark:text-slate-900">Edit Data Model</h1>
            @if (session('success'))
            ...
            @endif
            <form action="{{ route('model.update', $dataById->id_model) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="w-72">
                        <div class="relative h-10 w-full min-w-[450px] mt-5">
                            <input
                                ...
                                placeholder=" " name="nama_model" value="{{ $dataById->nama_model }}" />
                            <label
