    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
            ...
            <table id="example" class="display border border-slate-200" style="width:100%">
                <thead>
                    <tr>
                        <th class="border border-slate-200 text-center w-2">No</th>
                        <th class="border border-slate-200 text-center">Nama ukuran</th>
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-200">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('ukuran.edit', $baris->id_ukuran) }}">
                                        <button
                                    ...
                                    <form action="{{ route('ukuran.destroy', $baris->id_ukuran) }}" method="post"
