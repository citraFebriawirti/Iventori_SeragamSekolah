            ...
            <table id="example" class="display border border-slate-200" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="border border-slate-200 text-center">Nama Bahan</th>
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-200">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('bahan.edit', $baris->id_bahan) }}">
                                        <button
                                    ...
                                    <form action="{{ route('bahan.destroy', $baris->id_bahan) }}" method="post"
