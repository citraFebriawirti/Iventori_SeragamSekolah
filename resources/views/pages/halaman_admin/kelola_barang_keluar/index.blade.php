...
@section('content')
    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
            ...
            <div class="flex justify-between">
              <div class="mb-10">
                  <form action="{{ route('filterBarangKeluar') }}" method="POST" class="">
                      @csrf
                     ...
                     <div class="flex justify-center mt-2 ">
                      ...
                      @if($filter === 'true')
                      <a href="filterBarangKeluarTanggal/{{ $tanggal_awal }}/{{ $tanggal_akhir }}" class="bg-yellow-500 text-white p-2 rounded  ml-2" target="_blank">Laporan By Filter</a>
                      @endif
              ...
              <div class="">
                 <div class="flex justify-center gap-10 ">
                  <div class="my-3" >
                      <a href="{{ route('laporanbarangkeluar.index') }}" class="flex items-center justify-between w-full p-2 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-green-500 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-purple">
                         <div class="mr-3">
                  ...
                  <div class="my-3 ">
                      <a href="{{ route('barang_keluar.create') }}" class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                         <div class="mr-3">
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-200">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('barang_keluar.edit', $baris->id_barang_keluar) }}">
                                        <button
                                    ...
                                    <form action="{{ route('barang_keluar.destroy', $baris->id_barang_keluar) }}" method="post"
